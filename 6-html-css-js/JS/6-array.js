...
// callback functions - functions that can be passed as parameters

// it's assuming that the function we're passing as a parameter takes in 1 parameter itself
list.forEach(doSomething); // notice that there are NO () after the method

// I will define a function to be passed as a callback
// this will do what I want to do TO EACH ELEMENT IN THE ARRAY that I call it on

function doSomething(input) { // input represents the element it's operating on

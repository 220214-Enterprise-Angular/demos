...
@Data // if you don't have Lombok, create getters/setters & toString
@EqualsAndHashCode(callSuper=false) // prevent an infinite loop that occurs in bi-directional relationship 

 ...
 * exceptions that are sent to the client as HTTP responses 
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
		...
		// TODO: build our OWN buildResponseEntity() method to return a custom response
		...
		// return the firls that are NOT valid
